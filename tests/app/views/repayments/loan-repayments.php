...
$paid         = $totalPaid;
$pct          = $totalPayable > 0 ? min(100, round(($paid / $totalPayable) * 100)) : 0;
?>

<div class="d-flex align-items-center justify-content-between mt-4 mb-3 flex-wrap gap-2">
    <div>
        <h1 class="h3 mb-1 fw-bold text-gray-800">
            <i class="bi bi-clock-history me-2" style="color:var(--brand-orange)"></i>Repayment History
        </h1>
        <p class="text-muted mb-0 small"><?= htmlspecialchars($loan['loan_number']) ?> — <?= htmlspecialchars($loan['first_name'].' '.$loan['last_name']) ?></p>
    </div>
