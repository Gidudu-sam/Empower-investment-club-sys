...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .voucher-amount .amount-value .currency { font-size:.85rem; font-weight:500; color:var(--orange); }
        ...
        .voucher-footer .org-footer { font-size:.6rem; color:#9ca3af; margin-top:.5rem; }
