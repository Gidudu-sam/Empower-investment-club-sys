...
body { font-family: 'Segoe UI', Arial, sans-serif; font-size: 10pt; color: #1a1a1a; background: #e8eaf0; }
...
.stmt-header { padding: 22px 28px 16px; border-bottom: 4px solid #F47920; display: flex; align-items: center; justify-content: space-between; background: #fff; position: relative; z-index: 1; }
...
.acct-info-box { display: grid; grid-template-columns: 1fr 1fr; gap: 8px 24px; font-size: 0.82rem; margin-bottom: 22px; background: #f8f9fc; padding: 14px 18px; border-radius: 6px; border: 1px solid #e2e8f0; }
.acct-info-row { display: grid; grid-template-columns: 150px 1fr; gap: 0 12px; align-items: baseline; padding-bottom: 4px; border-bottom: 1px dashed #e2e8f0; }
.acct-info-row:last-child { border-bottom: none; padding-bottom: 0; }
.acct-info-label { color: #64748b; font-weight: 500; white-space: nowrap; }
.acct-info-val { color: #1e293b; font-weight: 600; }
...
.stmt-table { width: 100%; border-collapse: collapse; font-size: 0.72rem; margin-bottom: 24px; border: 1px solid #cbd5e1; }
.stmt-table th { background: #1B2B6B; color: #fff; text-align: center; padding: 6px 4px; font-size: 0.6rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.03em; border: 1px solid #cbd5e1; }
...
.stmt-footer-note { text-align: center; margin-top: 24px; padding-top: 14px; border-top: 1px dashed #cbd5e1; font-size: 0.75rem; color: #475569; line-height: 1.6; }
...
.stmt-footer-bar { padding: 12px 28px; border-top: 3px solid #F47920; display: flex; align-items: center; justify-content: center; gap: 8px; background: #fff; }
...
<div class="page-wrap">
    <div class="toolbar no-print" style="flex-wrap:wrap;align-items:center;">
        ...
        <form method="GET" style="display:flex;gap:.4rem;align-items:center;margin-left:auto;">
            ...
            <label style="font-size:.8rem;color:#475569;">From
                <input type="date" name="date_from" value="<?= htmlspecialchars($dateFrom) ?>" style="padding:.3rem .5rem;border:1px solid #cbd5e1;border-radius:5px;font-size:.82rem;">
            </label>
            <label style="font-size:.8rem;color:#475569;">To
                <input type="date" name="date_to" value="<?= htmlspecialchars($dateTo) ?>" style="padding:.3rem .5rem;border:1px solid #cbd5e1;border-radius:5px;font-size:.82rem;">
            </label>
    ...
    <div class="stmt-card">
        ...
        <div class="stmt-body">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    <tr>
                        <td colspan="7" style="font-style:italic;color:#475569;">Opening Balance</td>
                        <td class="text-right amount-balance">Shs <?= number_format($openingBalance, 2) ?></td>
                    </tr>
                    <?php if (empty($transactions)): ?>
                        <tr><td colspan="8" class="text-center" style="padding:14px;color:#64748b;font-style:italic;">No transactions in this period.</td></tr>
                    <?php else: ?>
            ...
            <div style="text-align:center;margin:24px 0 20px;display:flex;align-items:center;gap:12px;">
                ...
                <span style="font-size:0.72rem;font-weight:700;letter-spacing:0.12em;color:#475569;text-transform:uppercase;white-space:nowrap;">— End of Statement —</span>
                <div style="flex:1;height:1px;background:#cbd5e1;"></div>
            </div>
            ...
            <div style="margin-bottom:20px;">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        <tr>
                            <td style="padding:12px 14px;text-align:center;border:1px solid #cbd5e1;font-weight:600;color:#1e293b;font-size:0.88rem;"><?= number_format($openingBalance, 2) ?></td>
                            <td style="padding:12px 14px;text-align:center;border:1px solid #cbd5e1;font-weight:600;color:#dc2626;font-size:0.88rem;"><?= number_format($totalDebits, 2) ?></td>
                            <td style="padding:12px 14px;text-align:center;border:1px solid #cbd5e1;font-weight:600;color:#16a34a;font-size:0.88rem;"><?= number_format($totalCredits, 2) ?></td>
                            <td style="padding:12px 14px;text-align:center;border:1px solid #cbd5e1;font-weight:700;color:#1B2B6B;font-size:0.88rem;"><?= number_format($closingBalance, 2) ?></td>
                        </tr>
                    </tbody>
                </table>
                </div>
