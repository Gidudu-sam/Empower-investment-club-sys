...
<div class="d-flex align-items-center justify-content-between mt-4 mb-3 flex-wrap gap-2">
    <div>
        <h1 class="h3 mb-1 fw-bold text-gray-800">
            <i class="bi bi-box-arrow-up-right me-2 text-danger"></i>Withdrawal Reports
        </h1>
        <p class="text-muted mb-0 small">Annual Withdrawal Report · Financial Year <?= $year ?></p>
    </div>
    <div class="d-flex gap-2 flex-wrap no-print">
        <button onclick="window.print()" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-printer me-1"></i>Print
        </button>
        <button onclick="exportTable('withdrawalTable','withdrawal_report')" class="btn btn-outline-success btn-sm">
