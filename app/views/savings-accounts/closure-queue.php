<?php
$pageTitle = $pageTitle ?? 'Savings Account Closure Requests';
$title     = $pageTitle;
...
?>
    ...
    <div class="alert alert-secondary small">
        Fixed Deposit closure requests are reviewed on their own dedicated
        queue — <a href="<?= $base ?>?page=savings-account-fd-closures">Fixed Deposit Closures</a>.
    </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr><td colspan="7" class="text-center text-muted py-4">No pending closure requests.</td></tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= $base ?>?page=savings-account-closure-review&id=<?= (int)$r['id'] ?>" class="btn btn-sm btn-primary">
                                Review
                            </a>
                        </td>
                    </tr>
