                                ...
                                <tr class="<?= !$c['is_active'] ? 'text-muted' : '' ?>">
                                    ...
                                    <?php if ($canWrite): ?>
                                        <td class="text-end pe-3">
                                            ...
                                            <form method="POST"
                                                  action="<?= APP_URL ?>/index.php?page=expense-category-toggle"
                                                  class="d-inline"
...
<div class="modal fade" id="createCategoryModal" tabindex="-1" aria-labelledby="createCategoryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="<?= APP_URL ?>/index.php?page=expense-category-store">
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken) ?>">

                <div class="modal-header">
                    <h5 class="modal-title" id="createCategoryModalLabel">
                        <i class="bi bi-plus-circle me-2"></i>New Expense Category
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="create_description"
                                  ...
                                  class="form-control"
                                  rows="2"
                                  placeholder="Brief description of what expenses belong here"></textarea>
                    </div>
                    ...
                    <div class="mb-1">
                        ...
                        <div class="form-text">
                            ...
                            Required — a category cannot be saved without a GL account mapped.
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="editCategoryModal" tabindex="-1" aria-labelledby="editCategoryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="<?= APP_URL ?>/index.php?page=expense-category-update">
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken) ?>">
                <input type="hidden" name="id" id="edit_id">

                <div class="modal-header">
                    <h5 class="modal-title" id="editCategoryModalLabel">
                        <i class="bi bi-pencil me-2"></i>Edit Expense Category
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-1">
                        ...
                        <div class="form-text">
                            <i class="bi bi-info-circle me-1"></i>
                            Required — changing the GL mapping only affects future expense postings.
                        </div>
                    </div>
                </div>
...
<script>
// Populate edit modal with the row's data when the Edit button is clicked
