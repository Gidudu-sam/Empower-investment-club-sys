-- ============================================================
--  Stage 2.1: V2.1 Multi-Approval Architecture — CORRECTED Schema
--  DISPOSABLE TEST DATABASE ONLY
--  Database: empower_approval_test_v21
--  Date: 2026-09-14
--  
--  CORRECTIONS FROM STAGE 2 DEFECTS:
--  1. DEFECT #1: Added BEFORE DELETE trigger on approval_actions
--  2. DEFECT #2: Added BEFORE UPDATE trigger on approval_actions
--  3. DEFECT #3: Added officer loan tier (Tier 5)
-- ============================================================

-- 1. Create test database
CREATE DATABASE IF NOT EXISTS `empower_approval_test_v21` 
CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE `empower_approval_test_v21`;

-- ============================================================
--  V2.1 APPROVAL SCHEMA (CORRECTED)
-- ============================================================
...
-- ============================================================
--  V2.1 CORRECTION #1: IMMUTABILITY TRIGGER - PREVENT DELETE
-- ============================================================
...
-- ============================================================
--  V2.1 CORRECTION #2: IMMUTABILITY TRIGGER - PREVENT UPDATE
-- ============================================================
...
(5, 'member1', 'Alice Brown (Member)', 'member', 1),
(6, 'secretary2', 'Bob Davis (Secretary 2)', 'secretary', 1),
(7, 'admin', 'Carol White (Admin)', 'admin', 1),
(8, 'officer1', 'David Green (Officer)', 'chairman', 1);

-- ============================================================
--  SEED APPROVAL POLICY V1 (WITH OFFICER LOAN TIER - CORRECTION #3)
-- ============================================================

-- Create policy v1 for loans
...
INSERT INTO `approval_tier_slots` 
...
-- ============================================================
--  V2.1 CORRECTION #3: TIER 5 — OFFICER LOAN (ANY AMOUNT, 4 APPROVALS)
-- ============================================================
INSERT INTO `approval_tiers` 
...
-- ============================================================
--  END OF V2.1 CORRECTED SCHEMA
-- ============================================================

-- Verification queries
SELECT 'V2.1 Schema Created' AS status;
...
SELECT 'User Count' AS check_type, COUNT(*) AS value FROM test_users;
SELECT 'Triggers' AS check_type, 
       GROUP_CONCAT(TRIGGER_NAME SEPARATOR ', ') AS value 
FROM information_schema.TRIGGERS 
WHERE TRIGGER_SCHEMA = 'empower_approval_test_v21';
